...
class DeepNeuralNetwork:
    ...
    def train(self, X_train, y_train, learning_rate, iterations, batch_size, optimizer=tf.train.GradientDescentOptimizer):
        ...
        logits = self.calculate_layers(X, self.hidden_layer_list)[len(self.hidden_layer_list)-1]
        ...
        with tf.Session() as sess:
            ...
            for iterations in range(iterations):
                ...
                print(y_subset)
                print(logits.eval(feed_dict={X: X_subset}))
